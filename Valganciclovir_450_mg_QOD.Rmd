...
```{r}
library(readxl)
data_25_39_dvp_ML <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles pour dvp ML/data_25_39_dvp_ML.xlsx", 
...
predict(fit_workflow_3_2, valgan_ml_train_25_39 %>% dplyr::slice(1:3))
...
```{r}
library(vip)
xgb_fit <- extract_fit_parsnip(final_res_3_2)
vip(xgb_fit, geom = "point", num_features = 10)
```

```{r}
 saveRDS(fit_workflow_3_2, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_2_points_070324.rds")
```
...
```{r}
xgb_fit <- extract_fit_parsnip(final_res_3_3)
vip(xgb_fit, geom = "point", num_features = 10)
```

```{r}
 saveRDS(fit_workflow_3_3, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_3_points_070324.rds")
```
...
```{r}
 saveRDS(fit_workflow_3_3_bis, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_3_points_bis_070324.rds")
```
...
## data loading
```{r}
data_Clcr_25_39_Caldés <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles validation ML/data_Clcr_25_39_Caldés.xlsx", 
    col_types = c("text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
```{r}
fit_workflow_3_2 <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_2_points_070324.rds")
...
```{r}
fit_workflow_3_3 <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_3_points_070324.rds")
...
```{r}
fit_workflow_3_3_bis <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_25-39_3_points_bis_070324.rds")
...
```{r}
library(readxl)
data_25_39_Chen <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles validation ML/data_25_39_Chen.xlsx", 
    col_types = c("text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
```{r}
#pred scatterplot
prediction_mapb_Veniza_2_points %>%
...
```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points %>%
...
```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points_bis %>%
