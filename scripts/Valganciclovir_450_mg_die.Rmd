...
```{r}
#Save for future use
 saveRDS(fit_workflow_2_2, file = ".../algo/xgboost_40-59_2_points_070324.rds")
```
...
#Save 
#Save for future use
 saveRDS(fit_workflow_2_3, file = ".../algo/xgboost_40-59_3_points_070324.rds")
```
...
```{r}
#Save for future use
 saveRDS(fit_workflow_2_3_bis, file = ".../algo/xgboost_40-59_3_points_bis_070324.rds")
```
...
##data_set
```{r}
data_Clcr_40_59_Caldés <- read_excel("./data/data_Clcr_40_59_Caldés.xlsx", 
    col_types = c("text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
```{r}
fit_workflow_3_2 <- readRDS(".../algo/xgboost_40-59_2_points_070324.rds")
...
```{r}
fit_workflow_3_3 <- readRDS(".../algo/xgboost_40-59_3_points_070324.rds")
...
```{r}
fit_workflow_3_3_bis <- readRDS(".../algo/xgboost_40-59_3_points_bis_070324.rds")
