...
```{r}
#Save for future use
 saveRDS(fit_workflow_4_2, file = ".../algo/xgboost_10-24_2_points_070324.rds")
```
...
```{r}
#Save for future use
 saveRDS(fit_workflow_4_3, file = ".../algo/xgboost_10-24_3_points_070324.rds")
```
...
```{r}
#Save for future use
 saveRDS(fit_workflow_4_3_bis, file = ".../algo/xgboost_10-24_3_points_bis_070324.rds")
```
...
Bayesian prediction using the Lalagkas model on the 98 patients simulated from the Caldes model (valgan_40_59_test_1) (valgan_10_24_test_1) 
