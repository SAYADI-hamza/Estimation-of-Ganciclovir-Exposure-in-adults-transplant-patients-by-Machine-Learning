...
```{r}
library(readxl)
data_60_120_dvp_ML <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles pour dvp ML/data_60_120_dvp_ML.xlsx", 
...
```{r}
skim(valgan_dev_60_120)
```

```{r}
skim(valgan_val_60_120)
```
...
rmarkdown::paged_table(as.data.frame(final_res_predictions_1_1 %>% summarise(biais_rel = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_res_predictions_1_1 %>%
...
rmarkdown::paged_table(as.data.frame(final_res_predictions_1_2 %>% summarise(relative_biais = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
final_res_predictions_1_2 %>%
  ggplot(mapping = aes(x =AUC_pred, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
xgb_fit <- extract_fit_parsnip(final_res_1_2)

vip(xgb_fit, geom = "point", num_features = 5)
```

```{r}
 saveRDS(fit_workflow_1_2, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_2_points_070324.rds")
```
...
rmarkdown::paged_table(as.data.frame(final_res_predictions_1_3 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
final_res_predictions_1_3 %>%
  ggplot(mapping = aes(x =AUC_pred, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
xgb_fit <- extract_fit_parsnip(final_res_1_3)
...
# sauvegarde pour une utilisation ultérieure
 saveRDS(fit_workflow_1_3, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_3_points_070324.rds")
```
...
rmarkdown::paged_table(as.data.frame(final_res_predictions_1_3_bis %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
final_res_predictions_1_3_bis %>%
  ggplot(mapping = aes(x =AUC_pred, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
xgb_fit <- extract_fit_parsnip(final_res_1_3_bis)

vip(xgb_fit, geom = "point", num_features = 5)
```

```{r}
 saveRDS(fit_workflow_1_3_bis, file = "C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_3_points_bis_070324.rds")
```
...
```{r}
library(readxl)
data_normo_renaux_Caldés <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles validation ML/data_normo_renaux_Caldés.xlsx", 
    col_types = c("text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
```{r}
fit_workflow_1_2 <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_2_points_070324.rds")
...
rmarkdown::paged_table(as.data.frame(final_predictions_1_2 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_1_2 %>%
...
final_predictions_1_2 %>%
  ...
  geom_smooth(method=lm,color = "black")+
  labs(
    x = "Predited AUC (mg*h/L)",
    y = "Bias AUC (mg*h/L)")+  theme_bw()
```
...
```{r}
fit_workflow_1_3 <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_3_points_070324.rds")
...
rmarkdown::paged_table(as.data.frame(final_predictions_1_3 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_1_3 %>%
...
```{r}
fit_workflow_1_3_bis <- readRDS("C:/Users/hamza/Desktop/valganciclovir/algo/xgboost_60-120_3_points_bis_070324.rds")
...
rmarkdown::paged_table(as.data.frame(final_predictions_1_3_bis %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_1_3_bis %>%
...
#residual scatterplot
final_predictions_1_3_bis %>%
  ggplot(mapping = aes(x = AUC_pred_3_points, y = AUC_pred_3_points_bis - auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
    x = "Predicted AUC (mg*h/L)",
...
```{r}
library(readxl)
data_normo_renaux_Chen <- read_excel("C:/Users/hamza/Desktop/valganciclovir/data 2 modèles validation ML/data_normo_renaux_Chen.xlsx", 
    col_types = c("text", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "numeric", "numeric", 
...
rmarkdown::paged_table(as.data.frame(final_predictions_2_2 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_2_2 %>%
  ggplot(mapping = aes(x =AUC_pred_2_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(final_predictions_2_3 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_2_3 %>%
  ggplot(mapping = aes(x =AUC_pred_3_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(final_predictions_2_3_bis %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
final_predictions_2_3_bis %>%
  ggplot(mapping = aes(x =AUC_pred_3_points_bis, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_2_points_Ca_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_2_points_Ca_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_3_points_Ca_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points_Ca_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_3_points_bis_Ca_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points_bis_Ca_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_2_points_Ca_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_2_points_Ca_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_3_points_Ca_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_3_points_Ca_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_3_points_bis_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_3_points_bis_60_120 %>%
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_2_points_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_2_points_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Veniza_2_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_3_points_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Veniza_3_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Veniza_3_points_bis_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Veniza_3_points_bis_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Veniza_3_points_bis, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_2_points_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_2_points_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Lalagkas_2_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_3_points_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_3_points_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Lalagkas_3_points, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
...
rmarkdown::paged_table(as.data.frame(prediction_mapb_Lalagkas_3_points_bis_Ch_60_120 %>% summarise(relative_bias = mean(bias_rel), relative_rmse = sqrt(mean(bias_rel_square)),biais_out_20percent = mean(!between(bias_rel,-0.2, 0.2)), nb_out_20percent = sum(!between(bias_rel,-0.2, 0.2)), n= n())))
```

```{r}
#pred scatterplot
prediction_mapb_Lalagkas_3_points_bis_Ch_60_120 %>%
  ggplot(mapping = aes(x =AUC_mapb_Lalagkas_3_points_bis, y = auc)) +
  geom_point() +
  geom_smooth(method=lm,color = "black") +
  labs(
